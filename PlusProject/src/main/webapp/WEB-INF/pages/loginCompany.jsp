	...
	<section class="container">
		<nav class="navbar navbar-expand-lg custom_nav-container">
			<a class="/" href="/SpringMVCPersonal_Project"> <img
				src="./files/images/logo.png" alt="" /> <span> ProjectPluse
					Company Login </span>
			</a>
			...
			<form id="loginForm" action="loginCompany" class="form" method="post">
				...
				<!-- required title="Password must be at least 8 characters long."  pattern=".{8,}" -->

				<button type="submit">Login</button><br/>
 				<!-- To display the message -->
				<!-- displays when succesfully registration -->
				<p style="color: green">${registerMessage}</p>
				<!-- when credentials does not matched -->
				<p style="color: red">${msgKey}</p>
				<p style="color:blue">${msgkeyforProfile}</p><br/>
