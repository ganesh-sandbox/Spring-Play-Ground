  ...
  <body>
    ...
    <div class="column">
        <div class="input-box">
            ...
            <input type="text" placeholder="Enter phone number" name="phone" required pattern="\d{10,15}" title="Please enter a valid phone number with 10-15 digits." />
        </div>
        <div class="input-box">
    ...
    <div class="column">
        <div class="input-box">
            ...
            <input type="url" placeholder="Enter Your LinkedIn Username/Link" required name="linkedinName" />
        </div>
        <div class="input-box">
    ...
    <div class="column">
        ...
        <div class="input-box">
            ...
            <input type="text" placeholder="Enter Your Basic Charge for your Work" required name="charges" pattern="^\d+(\.\d{1,2})?$" title="Please enter a valid amount." />
        </div>
    </div>
    <br>
