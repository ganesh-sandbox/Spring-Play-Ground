...
<c:forEach items="${projectData}" var="e">
 <div class="container">
        <div class="job-details">
           <h1 class=>${e.projectTitle}</h1>
           <h3>${e.cemail}</h3>
	       <p style="font-size:18px;">${e.projectDescription}</p>
        ...
        <div class="info-boxes">
            <div class="info-box" id="salary-box">
              ...
              <object class="pdf" data="./files/webimages/${ef.projectf}" width="800" height="500"></object>
     
          <!-- IF the company name and email section want to the right side and above the button -->
	...
	<form class="form-block">
		<div class="row">
			...
			<div class="col-xs-12 col-sm-6 fl_icon">
				<div class="form-group fl_icon">
					...
					<input class="form-input" type="text" placeholder="Your email" value="${e.projectSkills}" readonly >
				</div>
			</div>
      ...
      <!-- Till here this secton is commented below  -->    
 ...
 <div class="form-popup" id="applyForm">
       <form id="projectApplicationForm" action="/PlusProject/applyforproject" method="post" enctype="multipart/form-data" class="form-container">
    <h2>Project Application</h2>

    <label for="projectname"><b>Project Name</b></label>
    <input type="text" id="projectname" placeholder="Enter Project Name" name="projectTitle" value="${e.projectTitle}" required readonly>

    <label for="projectcompany"><b>Project Organization</b></label>
    <input type="text" id="projectcompany" placeholder="Enter Project Organization" name="projectCompany" value="${e.cname}" required readonly>

    <label for="projectcompanyemail"><b>Project Organization Email</b></label>
    <input type="email" id="projectcompanyemail" placeholder="Enter Project Organization Email" name="projectCompanyEmail" value="${e.cemail}" required readonly>

    <c:forEach items="${freelancerData}" var="ef">
        <label for="candidatename"><b>Candidate Name</b></label>
        <input type="text" id="candidatename" placeholder="Enter Candidate Name" name="freelancerName" value="${ef.name}" required>

        <label for="candidateemail"><b>Candidate Email</b></label>
        <input type="email" id="candidateemail" placeholder="Enter Candidate Email" name="freelancerEmail" value="${ef.email}" required>
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-6 fl_icon">
				<div class="form-group fl_icon">
					<div class="icon"></div>
					<label><h2>Required Skills</h2></label>
					<input class="form-input" type="text" placeholder="Your email" value="${e.cemail}" readonly >
				</div>
			</div>
