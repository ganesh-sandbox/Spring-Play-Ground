  ...
  <body>
    ...
    <div class="colums">
        ...
        <div class="item">
            ...
            <input type="text" id="projectTitle" name="projectTitle" placeholder="AI Chat bot" />
        </div>
        <div class="item">
        ...
        <div class="item">
            ...
            <input id="skills" name="projectSkills" required />
        ...
        <div class="question">
            ...
            <input type="text" id="budget" name="projectBudget" placeholder="10000,20000" title="Please enter a valid number." required />
        </div>
        <br>
        <br>
         <br>
        ...
        <c:forEach items="${companyInfoKey}" var="e">
        
            <label>Company Name</label>
            <input type="hidden" name="cname" value="${e.companyName}" readonly />
            <label>Company Email</label>
            <input type="hidden" name="cemail" value="${e.companyEmail}" readonly />
        </c:forEach>
        <br>
        <h4>${message}</h4>
