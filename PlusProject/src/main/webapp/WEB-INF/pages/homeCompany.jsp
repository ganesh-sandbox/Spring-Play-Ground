      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <!-- For iteration used for each and taking the data from the session which is set into the list  -->                     	     
            	<c:forEach  items="${companydatakey}" var="e"> 
                    <p>WELCOME  ${e.companyName}</p>                     
                    <p>Contact No.  ${e.companyPhone}</p>                   
                    </c:forEach>
...
<div class="content">
      <c:forEach items="${allFreelancersKey}"  var="e">
        <div class="card-box">
            <div class="text-center">
                <div class="thumb-lg member-thumb mx-auto">
                    <img src="/PlusProject/files/webImages/${e.profilePhotoF}" class="rounded-circle img-thumbnail" alt="profile-image">
                </div>
              ...
              <a href="${e.linkedinName}" title="LinkedIn" class="btn btn-linkedin btn-lg" style="background-color:#3a86ff;""><i class="fa fa-linkedin fa-fw"></i> LinkedIn</a>
              <br>
                ...
                <div class="mt-4">
                    <div class="row">
                        <div class="col-4">
                            <div class="mt-3">
                                <h5>${e.charges} <i class="fa-solid fa-coins"></i></h5>
           ...
           <center> <a href="viewFreelancer" title="LinkedIn" class="btn btn-linkedin btn-lg" style="background-color:#3a86ff;"">View More<i class="fa-solid fa-caret-right"></i><i class="fa-solid fa-caret-right"></i></a></center>
