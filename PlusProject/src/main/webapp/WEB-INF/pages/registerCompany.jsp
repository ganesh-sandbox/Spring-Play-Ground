...
<html lang="en">
  ...
  <body>
    ...
    <div class="input-box">
        ...
        <input type="text" placeholder="Enter name" required name="companyName" pattern="[A-Za-z\s]{1,}" title="Name should only contain letters and spaces." />
    </div>

    <div class="input-box">
        <label>Email</label>
        <input type="email" placeholder="Enter email address" required name="companyEmail" />
    </div>

    <div class="input-box">
        <label>Phone Number</label>
        <input type="tel" placeholder="Enter Contact number" name="companyPhone" required pattern="\d{10}" title="Phone number should be 10 digits." />
    </div>

    <div class="input-box">
        <label>Company Website</label>
        <input type="url" placeholder="Enter Company Website" name="companyWebSite" required pattern="https?://.+" title="Enter a valid URL starting with http:// or https://." />
    </div>
    ...
    <div class="input-box">
        ...
        <input type="password" name="confirmPassword" placeholder="Enter Confirm Password"   title="Password must be at least 8 characters long." />
    </div>

    <button type="submit">Register</button>
    <br>
    
    <!-- To disply the success / error messge -->
