...
<table>
    ...
    <tbody>
        <c:forEach items="${myJobAppDetails}" var="e">
            <tr>
                <td data-label="Farmer Name">${e.companyName}</td>
                <td data-label="Product">${e.position}</td>
                <td data-label="Type">${e.freelancerName}</td>
                <td data-label="Price">${e.freelancerEmail}</td>
                <td data-label="Date">${e.resumePdf}
    ...
    <tbody>
        <c:forEach items="${myProjectApplications}" var="ef">
            <tr>
                ...
                <td data-label="Type">${ef.freelancerName}</td>
                <td data-label="Price">${ef.freelancerEmail}</td>
                <td data-label="Date">${ef.freelancerResume}</td>
