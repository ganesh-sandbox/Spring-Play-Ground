...
<br>
 ...
 <c:forEach items="${companydatakey }" var="ef"> 
 <div class="button-container">
        <a href="/PlusProject/acceptedApplications/${ef.companyName}"><button class="btn accepted" style="color:#fff;">Accepted Applications &nbsp;<i class="fa-solid fa-clipboard-check"></i></button></a>
        <a href="/PlusProject/rejectedApplications/${ef.companyName}"><button class="btn rejected" style="color:#fff;">Rejected Applications &nbsp; <i class="fa-regular fa-circle-xmark"></i></button></a>
 </div>
</c:forEach>
    ...
    <tbody>
        <c:forEach items="${applicationData}" var="e">
            <tr>
                ...
                <embed class="pdf" 
               src=
"/PlusProject/files/webImages/${e.resumePdf}"
            width="210" height="250">
            
             <a href="/PlusProject/files/webImages/${e.resumePdf}" class="download-button" download="ProjectPlus Resume.PDF" style="background-color:#457b9d;padding:5px; color:#fff;">Download Resume
    ...
    <i class="fa-solid fa-file-arrow-down"></i>
                ...
                <td> 
                 <form action="/PlusProject/updatestatusOfJobApplication" method="post">
...
<table>
    ...
    <tbody>
        ...
        <embed class="pdf" 
               src=
"/PlusProject/files/webImages/${ef.freelancerResume}"
            width="250" height="250">
            
            
             <a href="/PlusProject/files/webImages/${ef.freelancerResume}" class="download-button" download="ProjectPlus Resume.PDF" style="background-color:#457b9d;padding:5px; color:#fff;">Download Resume
    ...
    <i class="fa-solid fa-file-arrow-down"></i>
                ...
                <td> 
                 <form action="/PlusProject/updateprojectstatus" method="post">
