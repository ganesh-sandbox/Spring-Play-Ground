...
<c:forEach items="${alljobData}" var="e">
 <div class="container">
        ...
        <div class="info-boxes">
      	 ...
      	 <!-- Pop UP Form Section  -->
      	 <!-- Note : action attribute have project_name/target_handler_uri since it is popup form submission (like sub form)-->
    <div class="form-popup" id="applyForm">
      <form id="jobApplicationForm" action="/PlusProject/applyforjob" method="post" enctype="multipart/form-data" class="form-container">
    ...
    <input type="text" id="position" placeholder="Enter Your Position" value="${e.title}" name="position" required readonly>
			...
			<!-- Data for the POP UP Form -->
    <c:forEach items="${freelancerData}" var="ef">
        <label for="candidatename"><b>Candidate Name</b></label>
        <input type="text" id="candidatename" placeholder="Enter Your Name" value="${ef.name}" name="freelancerName" required>

        <label for="candidateemail"><b>Candidate Email</b></label>
        <input type="email" id="candidateemail" placeholder="Enter Your Email" value="${ef.email}" name="freelancerEmail" required>
