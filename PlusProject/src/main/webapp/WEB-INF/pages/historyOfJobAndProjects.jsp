...
<table>
    ...
    <tbody>
        <c:forEach items="${postJobHistory}" var="e">
            <tr>
                ...
                <td data-label="Date">
                 <a href="/PlusProject/editJob/${e.id}">Edit &nbsp;<i class="fa-regular fa-pen-to-square"></i></a>
                 <br>
                 <br>
                 <br>
                 <a href="/PlusProject/removejob/${e.id}">Remove &nbsp;  <i class="fa-solid fa-user-xmark"></i></a>
...
<table>
    ...
    <tbody>
        <c:forEach items="${postProjectHistory}" var="ef">
            <tr>
        ...
        <embed class="pdf" 
               src=
"/PlusProject/files/webImages/${ef.projectPdf}"
            width="250" height="250">
                 ...
                 <br>
                 <br>
                 <a href="/PlusProject/removeproject/${ef.id}">Remove &nbsp;  <i class="fa-solid fa-user-xmark"></i></a>
