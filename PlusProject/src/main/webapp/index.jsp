 ...
 <div class="hero_area">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  ">
              <li class="nav-item active">
                <a class="nav-link" href="/PlusProject">Home &nbsp; <i class="fa-solid fa-house"></i> <span class="sr-only">(current)</span></a>
              </li>
              <li class="nav-item">
  ...
  <div class="content">
        ...
        <div class="card-box ">
            <div class="text-center">
                <div class="thumb-lg member-thumb mx-auto">
                    <img src="./files/images/ganeshkamble.png" class="rounded-circle img-thumbnail" alt="profile-image">
                </div>
                <input type="hidden" value="${e.id}">
                <div>
                    <h4>Ganesh Kamble</h4>	
                    <h6>ganesh@gmail.com &nbsp<i class="fa-solid fa-paper-plane"></i></h6>
              ...
              <a href="https://www.linkedin.com/in/ganeshkamble1995/" title="LinkedIn" class="btn btn-linkedin btn-lg" style="background-color:#3a86ff;"><i class="fa fa-linkedin fa-fw"></i> LinkedIn</a>
              <br>
                ...
                <div class="mt-4">
                    <div class="row">
                        <div class="col-4">
                            <div class="mt-3">
                                <h5>790000 <i class="fa-solid fa-coins"></i></h5>
                        ...
                        <div class="col-4">
                            <div class="mt-3">
                                <h5>22/10/1995 &nbsp<i class="fa-solid fa-calendar-days"></i></h5>
         ...
         <div class="card-box " style="background-color:#e9d8a6">
            <div class="text-center">
                <div class="thumb-lg member-thumb mx-auto">
                    <img src="./files/images/gajendrachincholikar.png" class="rounded-circle img-thumbnail " alt="profile-image">
                </div>
                <input type="hidden" value="${e.id}">
                <div>
                    <h4>Gajendra Chincholikar</h4>
                    <h6>gajendra@gmail.com} &nbsp<i class="fa-solid fa-paper-plane"></i></h6>
              ...
              <a href="https://www.linkedin.com/in/gajendra-chincholikar/" title="LinkedIn" class="btn btn-linkedin btn-lg" style="background-color:#3a86ff;"><i class="fa fa-linkedin fa-fw"></i> LinkedIn</a>
              <br>
                ...
                <div class="mt-4">
                    <div class="row">
                        <div class="col-4">
                            <div class="mt-3">
                                <h5>79000 <i class="fa-solid fa-coins"></i></h5>
                                <p class="mb-0 text-muted">Per Month Charge</p>
                            </div>
                        </div>
                        <div class="col-4">
                        ...
                        <div class="col-4">
                            <div class="mt-3">
                                <h5>03/01/1998 &nbsp<i class="fa-solid fa-calendar-days"></i></h5>
                                <p class="mb-0 text-muted">Date of Birth</p>
                            </div>
                        </div>
                    </div>
         ...
         <div class="card-box " style="background-color:#94d2bd;">
            <div class="text-center">
                <div class="thumb-lg member-thumb mx-auto">
                    <img src="./files/images/rushikeshchoudhary.jpeg" class="rounded-circle img-thumbnail" alt="profile-image">
                </div>
                <input type="hidden" value="${e.id}">
                <div>
                    <h4>Rushikesh Choudhary</h4>
                    <h6>rushikesh@gmail.com &nbsp<i class="fa-solid fa-paper-plane"></i></h6>
              ...
              <a href="https://www.linkedin.com/in/rushikesh-choudhary/" title="LinkedIn" class="btn btn-linkedin btn-lg" style="background-color:#3a86ff;"><i class="fa fa-linkedin fa-fw"></i> LinkedIn</a>
              <br>
                ...
                <div class="mt-4">
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="mt-3">
                                <h5>24/08/1995&nbsp<i class="fa-solid fa-calendar-days"></i></h5>
                                <p class="mb-0 text-muted">Date of Birth</p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="card-box " style="background-color:#e9d8a6">
            <div class="text-center">
                <div class="thumb-lg member-thumb mx-auto">
                    <img src="./files/images/shailendrasisodia.png" class="rounded-circle img-thumbnail " alt="profile-image">
                </div>
                <input type="hidden" value="${e.id}">
                <div>
                    <h4>Shailendra Sisodia</h4>
                    <h6>shail@gmail.com &nbsp<i class="fa-solid fa-paper-plane"></i></h6>
                    <p class="text-muted">Skills<span><i class="fa-brands fa-nutritionix"></i><br> </span><span><a href="#" class="text-pink">Java, Jirs, Manual Testing ,Automation,Selenium</a></span></p>
                </div>
              <a href="https://www.linkedin.com/in/shailendra-sisodia/" title="LinkedIn" class="btn btn-linkedin btn-lg" style="background-color:#3a86ff;"><i class="fa fa-linkedin fa-fw"></i> LinkedIn</a>
              <br>
                ...
                <div class="mt-4">
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="mt-3"> 
                                <h5>03/01/1995 &nbsp<i class="fa-solid fa-calendar-days"></i></h5>
                                <p class="mb-0 text-muted">Date of Birth</p>
                            </div>
                        </div>
                    </div>
    ...
    <center> <a href="loginCompany" title="LinkedIn" class="btn btn-linkedin btn-lg" style="background-color:#3a86ff;"">View More<i class="fa-solid fa-caret-right"></i><i class="fa-solid fa-caret-right"></i></a></center>
      ...
      <div class="col-md-3 col-lg-4">
        <div class="card mb-4 project" data-groups="[&quot;skill1&quot;]">
          <figure class="portfolio-item">
            <a href="loginfreelancer" class="hovereffect">
          ...
          <div class="card-body">
            ...
            <p class="card-text mt-3 fs-14" style="color:blue;"><b>Required Skills:</b>Strong Fundamentals from core java,Collection API,Spring Frmaework,HandsOn Knowledge on Spring Boot and SPring MVC,DSA concept awarness.</p>
            <center><a href="loginfreelancer"><button type="button" class="btn btn-primary">View and Apply</button></a></center>
          </div><!-- / card-body -->
        </div><!-- / card -->
      </div><!-- / col-md-6 -->
...
Core python expertise</p>
       ...
       <center> <a href="loginfreelancer" title="LinkedIn" class="btn btn-linkedin btn-lg" style="background-color:#3a86ff;"">View More & Apply  &nbsp;<i class="fa-solid fa-arrow-up-right-from-square"></i></a></center>
...
Health administration</a>
            <br>
            <a href="single-project6.html" class="card-title title-link fs-16 fw-bold">Ganesh info Technologies</a>
            <p class="card-text mt-3 fs-14" style="color:blue;"><b>Required Skills:</b>Spring Boot,Spring MVC,Postgresql,Hibernate,SQL</p>
            
            <center><a href="loginfreelancer"><button type="button" class="btn btn-primary">View and Apply <i class="fa-solid fa-angles-right"></i></button></a></center>
...
Building chatbots</a>
 ...
 <center> <a href="loginfreelancer" title="LinkedIn" class="btn btn-linkedin btn-lg" style="background-color:#3a86ff;"">View More<i class="fa-solid fa-caret-right"></i><i class="fa-solid fa-caret-right"></i></a></center>
      ...
      <div class="container">
        <div class="info_top">
          ...
          <div class="social_box">
            ...
            <a href="https://twitter-cl.vercel.app/login">
        ...
        <div class="info_main">
          <div class="row">
            ...
            <div class="col-md-3 ">
              ...
              <p>
              Innovation Park,<br/>Pashan,<br/>Pune,Maharashtra
              </p>
            </div>
            ...
            <div class="col-md-3 col-lg-2 offset-lg-1">
              ...
              <p>
              <a href="https://www.linkedin.com/in/ganeshkamble1995/">Ganesh Kamble</a>
              </p>
            </div>
  ...
  <footer class="container-fluid footer_section ">
    <div class="container">
      <p>
        ...
        <a href="https://html.design/">Ganesh Kamble</a>
      </p>
    </div>
  </footer>
  <!-- end  footer section -->
